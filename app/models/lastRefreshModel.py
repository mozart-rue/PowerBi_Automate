...
def Insert_LastRefresh(data): 
    ...
    if data["end_time"]:
        ...
        query = f"""INSERT INTO last_refresh (
                            dataset_name,
                            dataset_id,
                            status,
                            refresh_type,
    ...
    try:
        ...
        print(f'LastRefreshModel :: Inserindo dados no banco :: ERROR => {err}')
        return False


# Funçao que faz delete 
def Delete_LastRefresh():
    
    # define a query para deletar
    query = "DELETE FROM last_refresh"
    ...
    try:
        ...
        print(f'LastrefreshModel :: Delete from database :: ERROR => {err}')
        pass
